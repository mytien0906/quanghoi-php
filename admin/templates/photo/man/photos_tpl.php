                            ...
                            <tr>
                                ...
                                <?php if(isset($config['photo']['man_photo'][$type]['avatar_photo']) && $config['photo']['man_photo'][$type]['avatar_photo'] == true) { ?>
	                                <td class="align-middle text-center">
	                                    <a href="<?=$linkEdit?>&id=<?=$items[$i]['id']?>" title="<?=$items[$i]['tenvi']?>"><img class="rounded img-preview" onerror="src='assets/images/noimage.png'" src="<?=THUMBS?>/<?=$config['photo']['man_photo'][$type]['thumb_photo']?>/<?=UPLOAD_PHOTO_L.$items[$i]['photo']?>" alt="<?=$items[$i]['tenvi']?>" style=" max-width:initial;"></a>
	                                </td>
	                            <?php } ?>
                                <?php if(isset($config['photo']['man_photo'][$type]['tieude_photo']) && $config['photo']['man_photo'][$type]['tieude_photo'] == true) { ?>
	                                <td class="align-middle">
