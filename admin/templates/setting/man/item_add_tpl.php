			...
			<div class="card-body">
				...
				<div class="row">
					...
					<?php if(isset($config['setting']['hotline']) && $config['setting']['hotline'] == true) { ?>
						<div class="form-group col-md-4 col-sm-6">
							<label for="hotline">Hotline 1:</label>
					...
					<?php if(isset($config['setting']['dienthoai']) && $config['setting']['dienthoai'] == true) { ?>
						<div class="form-group col-md-4 col-sm-6">
							<label for="dienthoai">Hotline 2:</label>
							<input type="text" class="form-control" name="data[options][dienthoai]" id="dienthoai" placeholder="Hotline" value="<?=$options['dienthoai']?>">
						</div>
					<?php } ?>
					...
					<?php if(isset($config['setting']['copyright']) && $config['setting']['copyright'] == true) { ?>
						<div class="form-group col-md-12 col-sm-12">
							...
							<input type="text" class="form-control" name="data[options][copyright]" id="copyright" placeholder="Câu copyright" value="<?=$options['copyright']?>">
						</div>
					<?php } ?>
				</div>
