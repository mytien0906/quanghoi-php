<?php
    ...
    $countNotify += count($contactNotify) + count($dangkyNotify);
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right shadow">
                ...
                <div class="dropdown-divider"></div>
                <a href="index.php?com=contact&act=man&type=contact" class="dropdown-item"><i class="fas fa-envelope mr-2"></i><span class="badge badge-danger mr-1"><?=count($contactNotify)?></span> Liên hệ</a>
