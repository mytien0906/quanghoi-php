...
<aside class="main-sidebar sidebar-dark-primary elevation-4 text-sm">
    ...
    <a class="brand-link" href="index.php">
        <img class="brand-image" src="<?=THUMBS?>/0x75x2/<?=UPLOAD_PHOTO_L.$logo['photo']?>" alt="<?=$setting['tenvi']?>">
    </a>
                        ...
                        <ul class="nav nav-treeview">
                            <?php if(isset($value['product'])) { foreach($value['product'] as $k) { 
                                ...
                                <?php if(isset($v['brand']) && $v['brand'] == true) {
                                    ...
                                    <li class="nav-item <?=$none?>"><a class="nav-link <?=$active?>" href="index.php?com=product&act=man_brand&type=<?=$k?>" title="Danh mục hãng"><i class="nav-icon text-sm far fa-caret-square-right"></i><p>Thương hiệu</p></a></li>
                                <?php } ?>
                        ...
                        <li class="nav-item has-treeview <?=$menuopen?> <?=$none?>">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <?php if(isset($v['mau']) && $v['mau'] == true) {
                                    ...
                                    if(isset($kiemtra) && $kiemtra == true) if($func->check_access('product', 'man_mau', $k, null, 'phrase-1')) $none = "d-none";
                                    if($com=='product' && ($act=='man_mau' || $act=='add_mau' || $act=='edit_mau') && $k==$_GET['type']) $active = "active"; ?>
                                    <li class="nav-item <?=$none?>"><a class="nav-link <?=$active?>" href="index.php?com=product&act=man_mau&type=<?=$k?>" title="Danh mục màu sắc"><i class="nav-icon text-sm far fa-caret-square-right"></i><p>Chủng loại</p></a></li>
                                <?php } ?>
                                <?php if(isset($v['size']) && $v['size'] == true) {
                                    $none = "";
                                    $active = "";
                                    if(isset($kiemtra) && $kiemtra == true) if($func->check_access('product', 'man_size', $k, null, 'phrase-1')) $none = "d-none";
                                    if($com=='product' && ($act=='man_size' || $act=='add_size' || $act=='edit_size') && $k==$_GET['type']) $active = "active"; ?>
                                    <li class="nav-item <?=$none?>"><a class="nav-link <?=$active?>" href="index.php?com=product&act=man_size&type=<?=$k?>" title="Danh mục kích thước"><i class="nav-icon text-sm far fa-caret-square-right"></i><p>Kích thước</p></a></li>
                                <?php } ?>
                                <?php if(isset($v['doday']) && $v['doday'] == true) {
                                    ...
                                    <li class="nav-item <?=$none?>"><a class="nav-link <?=$active?>" href="index.php?com=product&act=man_doday&type=<?=$k?>" title="Danh mục Độ dày"><i class="nav-icon text-sm far fa-caret-square-right"></i><p>Độ dày</p></a></li>
                                <?php } ?>
