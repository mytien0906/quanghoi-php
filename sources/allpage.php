<?php
    ...
    $huongdan = $d->rawQuery("select ten$lang, tenkhongdau$lang, mota$lang, ngaytao, id, photo from #_news where type = ? and hienthi > 0 order by stt,id desc ",array('huong-dan'));
